/* Data Structures Course — Quiz Widget (one-by-one) */
(function () {
  'use strict';
  ...
  function initQuiz(quizEl) {
    ...
    function showScore() {
      ...
      var msg = pct >= 80
        ? 'Excelent — ești pregătit pentru lecția următoare.'
        : 'Recitește secțiunile de mai sus înainte să continui.';
      scoreEl.innerHTML =
    ...
    function activateQuestion(qEl) {
      ...
      buttons.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          nextBtn.type = 'button';
          nextBtn.textContent = current < total - 1 ? 'Întrebarea următoare →' : 'Vezi rezultatele →';
